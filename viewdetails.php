...
#feedback input[type=submit]{margin-top:25px;margin-left:130px;padding:10px;border-radius:4px;background:#400040;color:#fff;border:1px solid #fff;}

#feedback input[type=submit]:hover{margin-top:25px;margin-left:130px;padding:10px;border-radius:4px;background:#fff;color:#400040;border:1px solid #425298;}

#img_container{width:800px;height:270px;background:#fff;margin-left:38%;margin-top:-270px;border:2px solid #400040;border-radius:4px;text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;}
#img_container ul li{float:left;list-style-type:none;margin-right:50px;margin-top:10px;}


#review{margin-top:20px;width:91.5%;height:auto;background:#fff;margin-left:80px;border:2px solid #400040;border-radius:4px;box-shadow: 3px 3px 3px #000;}

#review ul{width:96%;height:190px;margin-top:10px;background:#fff;border-bottom:2px solid #400040;}
...
<form method="post">
<h1 style="text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;margin-top:5px;width:95%;height:40px;line-height:40px;background:#400040;color:#fff;text-align:center;margin-left:20px;padding-left:10px;border-radius:4px;border:1px solid #400040;"><?php echo"".$row['pet_name']."";?></h1>
		<div id="pet1">
			<ul>
		...
		<div id="pet2">
		<ul>
		<li style="margin-top:95px; margin-left:110px;">Название:  <?php echo"".$row['pet_name']."";?></li>
		<li style="margin-top:95px; margin-left:110px;">Вес:  <?php echo"".$row['pet_color']."";?></li>
		<li style="margin-left:115px;margin-top:95px;">Стоимость:  <?php echo"".$row['pet_rate']."";?></li>
		
		
		<li style="margin-left:100px;margin-top:330px;"><a href="addtocart.php?id=<?php echo"".$row['pet_id']."";?>" style="width:100px;height:40px;background:#fff;color:#400040;border:1px solid #400040;text-decoration:none;padding:10px;">Добавить в корзину</a></li>
		</ul>
			</form></div><br><br>
		<?php
		...
		$query->execute();
		echo"<div id='pet'>
		<h1 style='text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;padding-left:10px;margin-left:60px;margin-top:20px;width:92%;background:#400040;color:#fff;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;'>Похожее</h1>";
		while($row1=$query->fetch()):
			...
			echo"<ul>
				<li><a href='viewdetails.php?id=".$row1['pet_id']."'>
					...
					<h1 style='text-align:center;font-size:20px;font-weight:normal;margin-top:10px;'>$  ".$row1['pet_rate']."</h1>
				</a></li>
			</ul>";
...
<h1 style="text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;padding-left:10px;margin-left:60px;margin-top:28%;width:92%;background:#400040;color:#fff;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;"></h1>
